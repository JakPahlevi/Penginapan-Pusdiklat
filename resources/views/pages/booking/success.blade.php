            ...
            <div class="flex gap-4">
                ...
                <div class="flex flex-col gap-3 w-full">
                    ...
                    <div class="flex items-center gap-[6px]">
                        ...
                        <p class="text-sm text-ngekos-grey">Kota {{$transaction->boardingHouse->category->name}}</p>
                    </div>
                    <div class="flex items-center gap-[6px]">
            ...
            <div class="flex gap-4">
                ...
                <div class="flex flex-col gap-3 w-full">
                    ...
                    <div class="flex items-center gap-[6px]">
                        ...
                        <p class="text-sm text-ngekos-grey">{{\Carbon\Carbon::parse($transaction->start_date)->isoFormat('D MMM YYY')}} - 
                            {{\Carbon\Carbon::parse($transaction->start_date)->addMonths($transaction->duration)->isoFormat('D MMM YYY')}}
                        </p>
                    </div>
                </div>
            </div>
