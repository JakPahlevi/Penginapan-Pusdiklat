...
<section id="Popular" class="flex flex-col gap-4  py-5 bg-white">
    <div class="flex items-center justify-between px-5">
        <h2 class="font-bold">Popular Kos</h2>
        <a href="{{route('popularhotel')}}">
    ...
    <div class="swiper w-full overflow-x-hidden">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide !w-fit">
                <a href="{{route('hotel.show', $boardingHouse->slug)}}" class="card">
        ...
        <a href="{{route('city.show', $city->slug)}}" class="card">
            <div class="flex items-center rounded-[22px] p-[10px] gap-3 bg-white border border-white overflow-hidden hover:border-[#91BF77] transition-all duration-300">
                ...
                <div class="flex flex-col gap-[2px]">
                    ...
                    <p class="text-sm text-ngekos-grey">{{$city->boardingHouse->count()}}</p>
                </div>
            </div>
        </a>@endforeach
    </div>
